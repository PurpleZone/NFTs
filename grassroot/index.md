---
title: seed, GrassRoot Climate Justice
--- 
## GrassRoot Climate Justice (courtesy @cryptolake2)

![seed](deeproot.svg)
<style>
img[alt=seed] { max-width: 20vw; float: right }
</style>
...
```yaml
intention: when our roots run deep
name: GrassRoot Climate Justice
symbol: seed
description: "By going back to our roots we can address the urgent crisis before our paralized governments"
```
